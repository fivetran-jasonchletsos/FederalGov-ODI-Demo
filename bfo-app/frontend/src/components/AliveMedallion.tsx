...
//
// Federal fork: HL7-specific copy replaced with federal-feed copy, and the
// HIPAA governance band swapped for FedRAMP / FISMA / OMB A-130. Otherwise
// identical to the Clarity / Verity source-of-truth implementation.
      ...
      <div className="am-grid">
        ...
        <section className="am-zone am-zone-sources">
          ...
          <footer className="am-zone-footer">
            ...
            <span>CDC + batch via Fivetran <span style={{ color: '#9ca3af' }}>·</span> Federal feeds stream via Kinesis</span>
          </footer>
        </section>
        ...
        <section className="am-zone am-zone-consumers">
          ...
          <div className="am-hipaa-band">
            ...
            <span className="am-hipaa-detail">FedRAMP · FISMA · OMB A-130 · row-level access · column masking</span>
          </div>
...
// ─── Particle flow between cylinder columns ─────────────────────────────────
