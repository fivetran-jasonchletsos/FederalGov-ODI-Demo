...
// Ported from Healthcare-EPIC-Snowflake-Demo for BFO.
...
export default function AgentAvatar({ agent, systemColor = '#1a365d', active = false, size = 40, from }: Props) {
  ...
  return (
    <span
      ...
      style={{
        ...
        borderRadius: 4,
        background: 'rgba(20,34,63,0.45)',
        border: `1.5px solid ${active ? color : 'rgba(20,34,63,0.7)'}`,
